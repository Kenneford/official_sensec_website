...
export function AllCourses({ allProgrammes }) {
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={2} flex={1}>
        <Grid item xs={12}>
          {leftProgrammes?.map((program) => (
            <Box className="courseWrap" id={program?.name} key={program?._id}>
                  ...
                  <Box className="courseInfo">
                    {program?.name === "Agric Science" && (
                      <p>
                        ...
                        Agriculture, Chemistry and Physics in addition to the
                        core subjects. The department has been planting
                        different types of crops each planting season and has
                        recently started a palm plantation in the school. Plans
                        are advance to start an animal farm. Subjects taught in
                        the Agricultural Science programme include Animal
                        Husbandry, Chemistry, Physics, General Agriculture and
                    ...
                    {program?.name === "Visual Arts" && (
                      <>
                        <p>
                          The Visual Art programme in SENSEC was rolled out in
                          the year 2005, through the effort of a visual art
                          teacher Mr. Nelson Appeadu under the leadership and
                          guidance of the then headmistress, Mrs Prah. Visual
                          Arts is a creative discipline that encompasses various
                          forms of visual expression such as drawing, painting,
                          sculpture and graphic design. The programme therefore
                          encourages students to explore their creativity,
                          imagination and self-expression through visual media.
                        </p>
                        <p>
                    ...
                    {program?.name === "General Science" && (
                      <p>
                        The General Science Programme was introduced in 2017,
                        with 8 students. The programme promotes scientific
                        literacy among students by helping them develop among
                        other competencies, problem solving skills, critical
                        thinking, and appreciation of the importance of
                        technology. Subjects taught in the General Science
                        programme include Biology, Chemistry, Information,
                        Communications and Technology (ICT), Elective
      ...
      <Grid container spacing={2} flex={1} mt={{ sm: "2rem", md: "5rem" }}>
        <Grid item xs={12}>
                  ...
                  <Box className="courseInfo">
                    {program?.name === "Business" && (
                      <p>
                        ...
                        business education, workplace, post-secondary education
                        or training and daily life. Elective subjects taught
                        here include Business Management, Principles of Cost
                        Accounting, Financial Accounting, Elective Mathematics
                        and Economics.
                      </p>
                    )}
                    {program?.name === "General Arts" && (
                      <p>
                        ...
                        various disciplines within the Arts and Humanities. The
                        programme of study is designed to foster intellectual
                        curiosity, critical thinking, and effective
                        communication skills. The programme overall aim is to
                        prepare students for a wide range of career
                        opportunities and personal development. Subjects taught
                        include Economics, Geography, History, Christian
                        Religious Studies, Government, Music, and Elective
                        Mathematics.
                      </p>
                    )}
                    {program?.name === "Home Economics" && (
                      <p>
                        Home Economics is an area of study that involves the
                        three basic needs of life, namely food, clothing and
                        shelter. The subject that are studied at the department
                        are Food and Nutrition, Clothing and Textiles,
                        Management in Living, Economics, General Knowledge in
                        Arts and Biology. The programme is practically oriented
                        and so equips students who offer it with employable
                        skills and therefore participate meaningfully in the
                        world of work.
                      </p>
                    )}
                    <Link to={"#"}>
