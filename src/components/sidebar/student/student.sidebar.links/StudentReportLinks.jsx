...
const quickLinks = [{ name: "View Report" }, { name: "Search" }];

export function StudentReportLinks({ hovered }) {
              ...
              <HashLink
                to={
                  Qlink.name === "Create Report"
                    ...
                    : `/sensec/users/${
                        authUser?.uniqueId
                      }/student/Academic_Report/${Qlink.name
                        .replace(/ /g, "_")
                        .toLocaleLowerCase()}`
                }
                // className="links"
