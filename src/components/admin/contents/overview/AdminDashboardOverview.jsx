...
export function AdminDashboardOverview() {
  ...
  return (
    <Box component={"div"} id="adminOverview" className={"adminOverviewWrap"}>
        ...
        <div className="content">
          <div className="dashBoardContent">
            <div className="card">
              <h3>Total Admins</h3>
              <HashLink
                to={"/sensec/admin/Users/Admins/employees/All"}
                className="cardInfo"
              >
              ...
              <HashLink
                to={"/sensec/admin/Users/Admins/employees/Pending_Admins"}
                className="pending"
              >
            ...
            <div className="card">
              ...
              <HashLink
                to={`/sensec/admin/Users/Lecturers/employees/All`}
                className="cardInfo"
              >
                <div
                  to={`/sensec/admin/Users/Lecturers`}
              ...
              <HashLink
                to={`/sensec/admin/Users/Lecturers/employees/Pending_Lecturers`}
                className="pending"
              >
            ...
            <div className="card">
              ...
              <HashLink
                to={`/sensec/admin/Users/Students/pending/all`}
                className="pending"
              >
            ...
            <div className="card">
              ...
              <HashLink
                to={"/sensec/admin/Users/NT-Staffs/employees/All"}
                className="cardInfo"
              >
                <div className="cardInfoIcons">
                  <Diversity3
              ...
              <HashLink
                to={"/sensec/admin/Users/NT-Staffs/employees/Pending_NT-Staffs"}
                className="pending"
              >
            ...
            <div className="card">
              <HashLink to={"/sensec/admin/Users/Blogs"}>
