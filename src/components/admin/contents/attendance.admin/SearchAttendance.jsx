  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box p={"1rem .5rem"}>
            <Box
              ...
              margin={"auto"}
            >
              <Box className="blogSearch" position={"relative"}>
                <CustomSearchField
                  label="Search student attendance"
                  variant="outlined"
                  value={searchedAttendance}
                  onChange={(e) => setSearchedAttendance(e?.target?.value)}
                  fullWidth
                  // margin="normal"
                  slotProps={{
                    input: {
        ...
        {/* Open search attendance by date */}
        <Box m={".5rem"}>
          <Box
          ...
          >
            ...
            >
              <Box className="attendanceSearch" p={"1rem 0"}>
                <h3 className="attTitle">Class Attendance Search</h3>
                {/* <button
                  className={!searchAttendance ? "openSearch" : "closeSearch"}
                  onClick={handleOpenAttendanceSearchInput}
                >
                  {searchAttendance ? "Close Search" : "Date Search"}
                </button> */}
              </Box>
              <Grid container spacing={2} className="flex4" p={"1rem 0"}>
                ...
                <Grid item xs={6} sm={3} className="attendanceDate">
                  <h4>Date:</h4>
                  <input type="date" className="attendanceDateInputBox " />
                </Grid>
                {/* {!searchAttendance && (
                  <Grid item xs={6} sm={3} className="attendanceDate">
                    <h4>Date:</h4>
