        ...
        <View style={styles.letterBody}>
          <View style={styles.addressedTo}>
            <View>
              <Text style={styles.text}>
                Dear {enrolledStudent?.personalInfo?.fullName},
              </Text>
            </View>
            <View>
              <Text style={styles.rightAlignedText}>
                <Text style={styles.rightAlignedBold}>Enrollment Code:</Text>{" "}
                {enrolledStudent?.studentSchoolData?.enrollmentCode
                  ? enrolledStudent?.studentSchoolData?.enrollmentCode
                  : "Unknown"}
              </Text>
              <Text style={styles.rightAlignedText}>
          ...
          <View style={styles.letterViews}>
            <Text style={styles.text}>
              ...
              house as a{" "}
              <Text style={{ textTransform: "lowercase", fontWeight: "bold" }}>
              ...
              is the programme offered to you. This will{" "}
              <Text
                style={{
                  textTransform: "uppercase",
                  fontWeight: "bold",
          ...
          <View style={styles.letterViews}>
            <Text style={styles.text}>
              ...
              has been enclosed for your serious study and strict compliance.
            </Text>
          </View>
          <View style={styles.letterViews}>
            <Text style={styles.text}>
              If your academic performance falls below expectation{" "}
              <Text style={[styles.text, styles.textSpan1]}>
          ...
          <View style={styles.letterViews}>
            <Text style={styles.text}>
              ...
              tuition is free. The official opening date for{" "}
              <Text style={[styles.text, styles.textSpan1]}>SHS-1</Text> is{" "}
              <Text style={[styles.text, styles.textSpan1]}>
                {currentTerm
                  ? dateFormatter?.format(new Date(currentTerm?.from))
                  : ".........................................."}
              </Text>
              , school management will meet all parents at{" "}
              <Text style={[styles.text, styles.textSpan1]}>11:00 am</Text> at
              the school assembly hall the same day. Please note that without
              your{" "}
              <Text style={[styles.text, styles.textSpan1]}>
                placement slip, enrollment form
              </Text>{" "}
              and{" "}
              <Text style={[styles.text, styles.textSpan1]}>
                BECE result slip
